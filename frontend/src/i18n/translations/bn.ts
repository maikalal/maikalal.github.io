...
export const bn: Record<TranslationKey, string> = {
  ...
  'button.claimProgress': 'হয়েছে',
  'button.claimMyProgress': 'চলুন',
  ...
  'stats.progress': 'অগ্রগতি',
  'stats.overallProgress': 'সবমিলিয়ে',
  ...
  // Ad modal
  'ad.title': 'বিজ্ঞাপন দেখুন',
  'ad.sponsored': 'বিজ্ঞাপন',
  'ad.viewed': 'বিজ্ঞাপন দেখা হয়েছে',
  'ad.loading': 'বিজ্ঞাপন লোড হচ্ছে...',
  'ad.secondsRemaining': 'সেকেন্ড বাকি',
  'ad.keepOpen': 'বিজ্ঞাপন বন্ধ করবেন না',
  'ad.closedEarly': 'আগেই বন্ধ হয়েছে',
  'ad.closedWindow': 'বিজ্ঞাপন বন্ধ করেছেন?',
  'ad.toContinue': 'বিজ্ঞাপন দেখুন',
  'ad.earnProgress': 'বিজ্ঞাপন দেখে আনলক করুন',
  'ad.clickToView': 'বিজ্ঞাপন দেখতে নিচে ক্লিক করুন',
  'ad.pleaseWait': 'অনুগ্রহ করে অপেক্ষা করুন...',
  'ad.success': 'বিজ্ঞাপন দেখা হয়েছে!',
  'ad.canClaim': 'প্রস্তুত!',
  'ad.watchFor': 'দেখুন',
  'ad.seconds': 'সেকেন্ড',
  
  // Empty states
  'empty.noUnlockables': 'কিছু নেই',
  'empty.noFavorites': 'পছন্দ নেই। ♥ ট্যাপ করে যোগ করুন।',
  'empty.noUnlocked': 'কিছু আনলক নেই। বিজ্ঞাপন দেখুন!',
  'empty.notFound': 'পাওয়া যায়নি',
  'empty.locked': 'লক করা',
  'empty.noItems': 'কিছু নেই',
  
  // Content
  'content.photo': 'ছবি',
  'content.photos': 'টি ছবি',
  'content.link': 'লিংক',
  'content.imageNotAvailable': 'ছবি নেই',
  'content.containsLink': 'লিংক আছে',
  'content.of': 'এর',
  
  // Maintenance
  'maintenance.title': 'মেরামতে আছে',
  'maintenance.message': 'অ্যাপ মেরামতে আছে। পরে দেখুন।',
  'maintenance.checkLater': 'পরে আবার দেখুন।',
