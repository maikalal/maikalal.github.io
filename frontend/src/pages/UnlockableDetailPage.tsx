...
export default function UnlockableDetailPage() {
    ...
    return (
      <Layout>
        <div className="flex flex-col items-center justify-center h-[80vh]">
          <p className="text-base-content/60 mb-4">Content not found</p>
  ...
  if (!isUnlocked) {
    return (
      <Layout>
        <div className="flex flex-col items-center justify-center h-[80vh]">
          <p className="text-base-content/60 mb-4">This content is locked</p>
          <button onClick={handleBack} className="btn btn-primary">
            Go Back
          </button>
        </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-4">
            <div className="bg-base-200 rounded-2xl p-8 text-center max-w-sm w-full">
              ...
              <p className="text-base-content/70 mb-4">
                This unlockable contains a link
              </p>
              <button
          ...
          >
            {unlockable.content[currentIndex] && !imageErrors.has(currentIndex) ? (
              ...
              <div className="flex flex-col items-center justify-center h-full">
                ...
                <p className="text-sm text-base-content/50 mt-2">Image not available</p>
              </div>
            )}
        ...
        <div className="p-4 bg-base-100">
          ...
          <div className="flex flex-wrap gap-2">
            <span className="badge badge-outline">
              {isLink ? 'Link' : `${unlockable.content.length} ${unlockable.content.length === 1 ? 'photo' : 'photos'}`}
            </span>
          </div>
        </div>
      </div>
