...
export default function UnlockedPage() {
  ...
  return (
    <Layout>
      <div className="p-4">
        {/* Header */}
        <h1 className="text-2xl font-bold mb-4">{t('page.unlocked')}</h1>
        ...
        <div className="stats shadow mb-4 w-full">
          <div className="stat">
            <div className="stat-title">{t('stats.totalUnlocked')}</div>
        ...
        <UnlockableList
          ...
          emptyMessage={t('empty.noUnlocked')}
        />
      </div>
    </Layout>
  );
