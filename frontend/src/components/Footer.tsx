...
export default function Footer() {
  ...
  const navItems = [
    { path: '/', label: 'All', icon: HomeIcon },
    { path: '/favorites', label: 'Favorites', icon: HeartIcon, badge: favoriteIds.size },
    { path: '/unlocked', label: 'Unlocked', icon: UnlockIcon, badge: unlockedIds.size },
