 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class za{constructor(e,t,n,r,s){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,t,n){const r=new Map;return r.set(e,Ga.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new za(Gs.min(),r,new ai(Is),$o(),Xo())}}class Ga{constructor(e,t,n,r,s){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new Ga(n,t,Xo(),Xo(),Xo())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Iu=null;function Eu(){return null===Iu?Iu=268435456+Math.round(2147483648*Math.random()):Iu++,"0x"+Iu.toString(16)
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e),e._firestoreClient}class Fl{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Fl(pi.fromBase64String(e))}catch(e){throw new hs(us.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(e){return new Fl(pi.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:Fl._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(qs(e,Fl._jsonSchema))return Fl.fromBase64String(e.bytes)}}Fl._jsonSchemaVersion="firestore/bytes/1.0",Fl._jsonSchema={type:js("string",Fl._jsonSchemaVersion),bytes:js("string")};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class jl{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new hs(us.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Os(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bl{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new hs(us.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new hs(us.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Is(this._lat,e._lat)||Is(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Bl._jsonSchemaVersion}}static fromJSON(e){if(qs(e,Bl._jsonSchema))return new Bl(e.latitude,e.longitude)}}Bl._jsonSchemaVersion="firestore/geoPoint/1.0",Bl._jsonSchema={type:js("string",Bl._jsonSchemaVersion),latitude:js("number"),longitude:js("number")};
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * limitations under the License.
 */
class $l{constructor(e){this._values=(e||[]).map(e=>e)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(e,t){if(e.length!==t.length)return!1;for(let n=0;n<e.length;++n)if(e[n]!==t[n])return!1;return!0}(this._values,e._values)}toJSON(){return{type:$l._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(qs(e,$l._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(e=>"number"==typeof e))return new $l(e.vectorValues);throw new hs(us.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}$l._jsonSchemaVersion="firestore/vectorValue/1.0",$l._jsonSchema={type:js("string",$l._jsonSchemaVersion),vectorValues:js("object")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const zl=/^__.*__$/;class Gl{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return null!==this.fieldMask?new Sa(e,this.data,this.fieldMask,t,this.fieldTransforms):new ba(e,this.data,t,this.fieldTransforms)}}class Hl{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return new Sa(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function Kl(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw is(40011,{dataSource:e})}}class Wl{constructor(e,t,n,r,s,i){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=r,void 0===s&&this.Ac(),this.fieldTransforms=s||[],this.fieldMask=i||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}i(e){return new Wl({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}dc(e){const t=this.path?.child(e),n=this.i({path:t,arrayElement:!1});return n.mc(e),n}fc(e){const t=this.path?.child(e),n=this.i({path:t,arrayElement:!1});return n.Ac(),n}gc(e){return this.i({path:void 0,arrayElement:!0})}yc(e){return ad(e,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}Ac(){if(this.path)for(let e=0;e<this.path.length;e++)this.mc(this.path.get(e))}mc(e){if(0===e.length)throw this.yc("Document fields must not be empty");if(Kl(this.dataSource)&&zl.test(e))throw this.yc('Document fields cannot begin and end with "__"')}}class Ql{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||Ou(e)}A(e,t,n,r=!1){return new Wl({dataSource:e,methodName:t,targetDoc:n,path:Os.emptyPath(),arrayElement:!1,hasConverter:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Jl(e){const t=e._freezeSettings(),n=Ou(e._databaseId);return new Ql(e._databaseId,!!t.ignoreUndefinedProperties,n)}function Yl(e,t,n,r,s,i={}){const o=e.A(i.merge||i.mergeFields?2:0,t,n,s);rd("Data must be an object, but it was:",o,r);const a=td(r,o);let c,u;if(i.merge)c=new di(o.fieldMask),u=o.fieldTransforms;else if(i.mergeFields){const e=[];for(const r of i.mergeFields){const s=sd(t,r,n);if(!o.contains(s))throw new hs(us.INVALID_ARGUMENT,`Field '${s}' is specified in your field mask but missing from your input data.`);cd(e,s)||e.push(s)}c=new di(e),u=o.fieldTransforms.filter(e=>c.covers(e.field))}else c=null,u=o.fieldTransforms;return new Gl(new Ji(a),c,u)}class Xl extends ql{_toFieldTransform(e){if(2!==e.dataSource)throw 1===e.dataSource?e.yc(`${this._methodName}() can only appear at the top level of your update data`):e.yc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Xl}}function Zl(e,t,n,r=!1){return ed(n,e.A(r?4:3,t))}function ed(e,t){if(nd(e=I(e)))return rd("Unsupported field value:",t,e),td(e,t);if(e instanceof ql)return function(e,t){if(!Kl(t.dataSource))throw t.yc(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.yc(`${e._methodName}() is not currently supported inside arrays`);const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.arrayElement&&4!==t.dataSource)throw t.yc("Nested arrays are not supported");return function(e,t){const n=[];let r=0;for(const s of e){let e=ed(s,t.gc(r));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=I(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return na(t.serializer,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=zs.fromDate(e);return{timestampValue:sc(t.serializer,n)}}if(e instanceof zs){const n=new zs(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:sc(t.serializer,n)}}if(e instanceof Bl)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof Fl)return{bytesValue:ic(t.serializer,e._byteString)};if(e instanceof kl){const n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.yc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:cc(e.firestore._databaseId||t.databaseId,e._key.path)}}if(e instanceof $l)return function(e,t){const n=e instanceof $l?e.toArray():e,r={fields:{[Ni]:{stringValue:Oi},[Pi]:{arrayValue:{values:n.map(e=>{if("number"!=typeof e)throw t.yc("VectorValues must only contain numeric values.");return ea(t.serializer,e)})}}}};return{mapValue:r}}(e,t);if(Nc(e))return e._toProto(t.serializer);throw t.yc(`Unsupported field value: ${Us(e)}`)}(e,t)}function td(e,t){const n={};return oi(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):ii(e,(e,r)=>{const s=ed(r,t.dc(e));null!=s&&(n[e]=s)}),{mapValue:{fields:n}}}function nd(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof zs||e instanceof Bl||e instanceof Fl||e instanceof kl||e instanceof ql||e instanceof $l||Nc(e))}function rd(e,t,n){if(!nd(n)||!Vs(n)){const r=Us(n);throw"an object"===r?t.yc(e+" a custom object"):t.yc(e+" "+r)}}function sd(e,t,n){if((t=I(t))instanceof jl)return t._internalPath;if("string"==typeof t)return od(e,t);throw ad("Field path arguments must be of type string or ",e,!1,void 0,n)}const id=new RegExp("[~\\*/\\[\\]]");function od(e,t,n){if(t.search(id)>=0)throw ad(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new jl(...t.split("."))._internalPath}catch(r){throw ad(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function ad(e,t,n,r,s){const i=r&&!r.isEmpty(),o=void 0!==s;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(i||o)&&(c+=" (found",i&&(c+=` in field ${r}`),o&&(c+=` in document ${s}`),c+=")"),new hs(us.INVALID_ARGUMENT,a+e+c)}function cd(e,t){return e.some(e=>e.isEqual(t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hd extends ud{constructor(e){super(),this.firestore=e}convertBytes(e){return new Fl(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new kl(this.firestore,null,t)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ld(){return new Xl("deleteField")}const dd="@firebase/firestore",fd="4.13.0";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pd(e){return function(e,t){if("object"!=typeof e||null===e)return!1;const n=e;for(const r of t)if(r in n&&"function"==typeof n[r])return!0;return!1}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gd{constructor(e="count",t){this._internalFieldPath=t,this.type="AggregateField",this.aggregateType=e}}class md{constructor(e,t,n){this._userDataWriter=t,this._data=n,this.type="AggregateQuerySnapshot",this.query=e}data(){return this._userDataWriter.convertObjectMap(this._data)}_fieldsProto(){return new Ji({mapValue:{fields:this._data}}).clone().value.mapValue.fields}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wd(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new hs(us.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class _d{}class Td extends _d{}function Id(e,t,...n){let r=[];t instanceof _d&&r.push(t),r=r.concat(n),function(e){const t=e.filter(e=>e instanceof Sd).length,n=e.filter(e=>e instanceof Ed).length;if(t>1||t>0&&n>0)throw new hs(us.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Md(e){return function(e,t){const n=Fs(e.firestore,Ml),r=Ul(n),s=function(e,t){const n=[];for(const r in e)Object.prototype.hasOwnProperty.call(e,r)&&n.push(t(e[r],r,e));return n}(t,(e,t)=>new La(t,e.aggregateType,e._internalFieldPath));return vl(r,e._query,s).then(t=>function(e,t,n){const r=new hd(e);return new md(t,r,n)}
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * limitations under the License.
 */
function Bd(e){e=Fs(e,kl);const t=Fs(e.firestore,Ml);return function(e,t,n={}){const r=new ls;return e.asyncQueue.enqueueAndForget(async()=>function(e,t,n,r,s){const i=new ll({next:a=>{i.Nu(),t.enqueueAndForget(()=>Ch(e,o));const c=a.docs.has(n);!c&&a.fromCache?s.reject(new hs(us.UNAVAILABLE,"Failed to get document because the client is offline.")):c&&a.fromCache&&r&&"server"===r.source?s.reject(new hs(us.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):s.resolve(a)},error:e=>s.reject(e)}),o=new Oh(Ao(n.path),i,{includeMetadataChanges:!0,qa:!0});return Sh(e,o)}(await yl(e),e.asyncQueue,t,n,r)),r.promise}(Ul(t),e._key).then(n=>Jd(t,e,n))}function $d(e){e=Fs(e,Al);const t=Fs(e.firestore,Ml),n=Ul(t),r=new hd(t);return wd(e._query),function(e,t,n={}){const r=new ls;return e.asyncQueue.enqueueAndForget(async()=>function(e,t,n,r,s){const i=new ll({next:n=>{i.Nu(),t.enqueueAndForget(()=>Ch(e,o)),n.fromCache&&"server"===r.source?s.reject(new hs(us.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):s.resolve(n)},error:e=>s.reject(e)}),o=new Oh(n,i,{includeMetadataChanges:!0,qa:!0});return Sh(e,o)}(await yl(e),e.asyncQueue,t,n,r)),r.promise}(n,e._query).then(n=>new jd(t,r,e,n))}function zd(e,t,n){e=Fs(e,kl);const r=Fs(e.firestore,Ml),s=xd(e.converter,t,n);return Qd(r,[Yl(Jl(r),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,ma.none())])}function Gd(e,t,n,...r){e=Fs(e,kl);const s=Fs(e.firestore,Ml),i=Jl(s);let o;return o="string"==typeof(t=I(t))||t instanceof jl?function(e,t,n,r,s,i){const o=e.A(1,t,n),a=[sd(t,r,n)],c=[s];if(i.length%2!=0)throw new hs(us.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let d=0;d<i.length;d+=2)a.push(sd(t,i[d])),c.push(i[d+1]);const u=[],h=Ji.empty();for(let d=a.length-1;d>=0;--d)if(!cd(u,a[d])){const e=a[d];let t=c[d];t=I(t);const n=o.fc(e);if(t instanceof Xl)u.push(e);else{const r=ed(t,n);null!=r&&(u.push(e),h.set(e,r))}}const l=new di(u);return new Hl(h,l,o.fieldTransforms)}(i,"updateDoc",e._key,t,n,r):function(e,t,n,r){const s=e.A(1,t,n);rd("Data must be an object, but it was:",s,r);const i=[],o=Ji.empty();ii(r,(e,r)=>{const a=od(t,e,n);r=I(r);const c=s.fc(a);if(r instanceof Xl)i.push(a);else{const e=ed(r,c);null!=e&&(i.push(a),o.set(a,e))}});const a=new di(i);return new Hl(o,a,s.fieldTransforms)}(i,"updateDoc",e._key,t),Qd(s,[o.toMutation(e._key,ma.exists(!0))])}function Hd(e){return Qd(Fs(e.firestore,Ml),[new Na(e._key,ma.none())])}function Kd(e,t){const n=Fs(e.firestore,Ml),r=Ol(e),s=xd(e.converter,t);return Qd(n,[Yl(Jl(e.firestore),"addDoc",r._key,s,null!==e.converter,{}).toMutation(r._key,ma.exists(!1))]).then(()=>r)}function Wd(e,...t){e=I(e);let n={includeMetadataChanges:!1,source:"default"},r=0;"object"!=typeof t[r]||pd(t[r])||(n=t[r++]);const s={includeMetadataChanges:n.includeMetadataChanges,source:n.source};if(pd(t[r])){const e=t[r];t[r]=e.next?.bind(e),t[r+1]=e.error?.bind(e),t[r+2]=e.complete?.bind(e)}let i,o,a;if(e instanceof kl)o=Fs(e.firestore,Ml),a=Ao(e._key.path),i={next:n=>{t[r]&&t[r](Jd(o,e,n))},error:t[r+1],complete:t[r+2]};else{const n=Fs(e,Al);o=Fs(n.firestore,Ml),a=n._query;const s=new hd(o);i={next:e=>{t[r]&&t[r](new jd(o,s,n,e))},error:t[r+1],complete:t[r+2]},wd(e._query)}return function(e,t,n,r){const s=new ll(r),i=new Oh(t,s,n);return e.asyncQueue.enqueueAndForget(async()=>Sh(await yl(e),i)),()=>{s.Nu(),e.asyncQueue.enqueueAndForget(async()=>Ch(await yl(e),i))}}(Ul(o),a,s,i)}function Qd(e,t){return wl(Ul(e),t)}function Jd(e,t,n){const r=n.docs.get(t._key),s=new hd(e);return new Ud(e,s,t._key,r,new Vd(n.hasPendingWrites,n.fromCache),t.converter)}jd._jsonSchemaVersion="firestore/querySnapshot/1.0",jd._jsonSchema={type:js("string",jd._jsonSchemaVersion),bundleSource:js("string","QuerySnapshot"),bundleName:js("string"),bundle:js("string")},function(e,t=!0){Xr=Ue,Pe(new S("firestore",(e,{instanceIdentifier:n,options:r})=>{const s=e.getProvider("app").getImmediate(),i=new Ml(new gs(e.getProvider("auth-internal")),new ws(s,e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new hs(us.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ki(e.options.projectId,t)}(s,n),s);return r={useFetchStreams:t,...r},i._setSettings(r),i},"PUBLIC").setMultipleInstances(!0)),qe(dd,fd,e),qe(dd,fd,"esm2020")}();export{zs as T,Vr as a,Bd as b,Dl as c,Ol as d,$d as e,Wd as f,Vl as g,Hd as h,Fe as i,zd as j,Rl as k,Nd as l,Md as m,Kd as n,Ad as o,ld as p,Id as q,Sn as r,Rd as s,Gd as u,bd as w};
